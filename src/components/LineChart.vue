...
export default {
  ...
  var renderVisualization = function(data_data, level){
              ...
              var svg = d3
                ...
                console.log("New Data :", data_data);

                var topics = data_data.topic_list
                var topics_unique = [...new Set(topics)]
                console.log("FCs", topics_unique);
          ...
          var x = function(data) {
           ...
           var y = d3.scaleTime()
                    .domain(d3.extent(data_patient, function(d) { 
                            // return new Date(d.start);
                            let mydate = Date.parse(d.start, "/dd/yyyy");
